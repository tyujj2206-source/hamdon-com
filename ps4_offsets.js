...
const key = major + "." + minor.toString(16).padStart(2, "0");

// إذا كان الإصدار 12.02 أو أعلى لكن أقل من 13.00، استخدم offsets الـ 12.00
if (major === 12 && minor >= 2) {
    return { key: key, off: PS4["12.00"] };
}

// إذا كان الإصدار 13.00 أو أعلى، استخدم offsets الـ 13.00
if (major >= 13) {
    return { key: key, off: PS4["13.00"] };
}

// باقي الإصدارات تستخدم الـ offsets الخاصة بها
